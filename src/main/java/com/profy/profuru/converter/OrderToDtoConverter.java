...
public class OrderToDtoConverter extends AbstractConverter<Orders, OrdersDTO> {
    @Override
    protected OrdersDTO convert(Orders source) {
        OrdersDTO destination = new OrdersDTO();
